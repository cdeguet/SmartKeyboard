...
public class OpenWnnDictionaryImpl implements WnnDictionary {
    ...
    static {
    	try {
    		...
    		Log.e("SmartKeyboard", "Could not load native library wnndict", ule);
    	}
    }
     ...
     */
    public OpenWnnDictionaryImpl( AssetFileDescriptor fd ) {
        this( fd, null );
    }
     ...
     */
    public OpenWnnDictionaryImpl( AssetFileDescriptor fd, String dicFilePath ) {
        /* Create the internal work area */
        this.mWnnWork = OpenWnnDictionaryImplJni.createWnnWork(fd.getFileDescriptor(), 

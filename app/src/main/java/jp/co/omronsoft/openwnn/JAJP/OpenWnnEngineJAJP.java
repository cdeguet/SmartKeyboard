...
public class OpenWnnEngineJAJP {
     ...
     */
    public OpenWnnEngineJAJP(AssetFileDescriptor fd) {
        /* load Japanese dictionary library */
        mDictionaryJP = new OpenWnnDictionaryImpl(fd, null);
     ...
     */
    private int setSearchKey(WordComposer text, int maxLen) {
        String input = text.getConvertedWord().toString();
        ...
        mInputRomaji = text.getTypedWord().toString();
    ...
    public int predict(WordComposer text, int maxLen) {
        clearCandidates();
